...
```
โปรเจคนี้ถูกสร้างขึ้นเพื่อเป็นสื่อการเรียนการสอนสำหรับผู้เริ่มต้น และเป็นพื้นฐานสำหรับต่อยอดไปสู่ Smart Home ที่ใช้งานได้จริง
หวังว่าโปรเจคนี้จะช่วยให้ผู้เรียนเข้าใจระบบ IoT, Docker, Automations และสามารถนำไปพัฒนาใช้งานในบ้านของตัวเองได้
รวมถึงใช้ประกอบการส่งมอบงานให้กับอาจารย์ที่ปรึกษาและใช้ในโปรเจคระดับมหาวิทยาลัยได้อย่างมืออาชีพ